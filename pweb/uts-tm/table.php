...
$sql = "SELECT * FROM Aspirasi ORDER BY tanggal_dibuat DESC";
  ...
  <nav class="relative bg-green-700/80 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              ...
              <a href="table.php" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white">Daftar Hasil Serap</a>
            </div>
          </div>
        </div>
    ...
    <div id="mobileMenu" class="hidden sm:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3">
        <a href="index.php" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Form
          Serap</a>
        <a href="table.php" aria-current="page" class="block rounded-md bg-gray-950/50 px-3 py-2 text-base font-medium text-white">Daftar Hasil Serap</a>
      </div>
    </div>
  </nav>
